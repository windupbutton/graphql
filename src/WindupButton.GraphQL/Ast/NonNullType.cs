...
{
    internal sealed class NonNullType : InputType
    {
        ...
        public NonNullType(NamedType type)
            : this((InputType)type)
        {
        }

        public NonNullType(ListType type)
            : this((InputType)type)
        {
        }
        ...
        {
            if (obj is NonNullType nonNullType)
            {
                return Type.Equals(nonNullType.Type);
            }
