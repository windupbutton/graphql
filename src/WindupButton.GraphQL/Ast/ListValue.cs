...
namespace WindupButton.GraphQL.Ast
{
    ...
    {
        public ListValue(IEnumerable<Value> value)
        {
        ...
        {
            if (obj is ListValue listValue)
            {
                return Value.SequenceEqual(listValue.Value);
            }
