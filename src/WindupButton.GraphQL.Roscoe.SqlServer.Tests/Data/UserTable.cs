...
namespace WindupButton.GraphQL.Roscoe.SqlServer.Tests.Data
{
    public sealed class UserTable : SqlServerTable
    {
        public UserTable(string alias = default)
            : base("users", "public", alias)
        {
        }

        public GuidColumn OrganisationId => Column()
